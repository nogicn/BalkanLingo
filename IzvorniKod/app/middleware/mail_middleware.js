...
const sendEmail = (email, password) => 
{
    ...
    secure: false, // false for TLS - as long as you're not using SSL
      auth: {
        ...
        pass: 'wevu yrmp qbwq syfg', //ne diraj
      },
    });
      ...
      <html>
          ...
          <body>
            <div class="container">
              ...
              <p><strong>Jednokratna lozinka:</strong> ${password}</p>
              <div class="button-container"><a href="https://balkanlingo.online/login" class="button">Prijavi se</a></div>
              <hr>
              <p><strong>Molimo vas da se što prije prijavite u sustav i promijenite lozinku.</p>
