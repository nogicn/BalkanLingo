...
\end{longtblr}
		...
		\section{Dijagram razreda}        
			...
			%\subsection{Dijagram Kontrollera}
            Dijagram kontrollera prikazuje koje su sve funkcije dostupne i koji router ih nasljeđuje. Također prikazuje i middleware funkcije i koji ih routeri koriste.
				\begin{figure}[H]
				...
				\end{figure}			
			\eject
            Dijagram ruta prikazuje koje su sve rute dostupne i koje modele koriste iz baze podataka.
           % \subsection{Dijagram Ruta}
				...
				\end{figure}			
			\eject
            Dijagram modela prikazuje kako su modeli povezani u bazi i koje atribute imaju.
