...
\end{longtblr}
		...
		\section{Dijagram razreda}        
            ...
            Dijagram kontrolera prikazuje koje su sve funkcije dostupne i koji router ih nasljeđuje. Također prikazuje i middleware funkcije i koji ih routeri koriste.
				\begin{figure}[H]
