\chapter*{Dodatak: Prikaz aktivnosti grupe}
		...
		\section*{Tablica aktivnosti}
			...
			\begin{longtblr}[
				...
				Arhitektura i dizajn sustava	 & 4 &  &  & 4 &  & 1 &2  \\ 
				Baza podataka				& 2 &  &  & 6 &  &  &   \\ 
				Dijagram razreda 			& 1 &  &2  &  &  &  &   \\ 
				Dijagram stanja				& 1 & 3 &3  &  &  & 3 &1  \\ 
				Dijagram aktivnosti 		& 1 & 3 &3  &  &  & 3 &  \\ 
				...
				Popis literature 			&  &  &  &  &  & & 1  \\  
				\textit{dizajniranje korisničkog sučelja} 			&  &  &  &  &  & 7 & 9  \\ 
				\textit{izrada početne stranice} 				&  &  &  &  & 5 & 3 &  \\  
				\textit{spajanje s bazom podataka} 							& 2 &  &  &  &  &  &  \\ 
				\textit{back end} 							&  6  & 4 & 4  & 1 &  &  \\  
