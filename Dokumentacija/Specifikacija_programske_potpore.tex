\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\begin{packed_enum}
				...
				\item \underbar{Servis za ocjenjivanje izgovora (sudionik):}
				\begin{packed_enum}
			...
			\subsection{Obrasci uporabe}
					...
					\begin{packed_item}
						...
						\begin{packed_enum}
							...
							\item Ručni unos naslovne fotografije, opisa rječnika i jezika učenja
					...
					\begin{packed_item}
						...
						\begin{packed_enum}
							...
							\item Administrator potvrđuje da je siguran da želi obrisati rječnik
						\end{packed_enum}
					\end{packed_item}
					...
					\begin{packed_item}
						...
						\begin{packed_enum}
							...
							\item Nakon pronalaska tražene riječi pritišćemo gumb za uklanjanje (-) pored iste
						\end{packed_enum}
						\item \textbf{Opis mogućih odstupanja:}
						\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC9.a Korisnik zaboravlja lozinku}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Neprijavljeni korisnik
					...
					\begin{packed_item}
						...
						\begin{packed_item}
							...
							\\2. Stranica se osvježava i korisnik se automatski odjavljuje
						\end{packed_item}
					\end{packed_item}
					...
					\begin{packed_item}
						...
						\begin{packed_enum}
							\item Administrator otvara postavke korisničkog profila
							\item Administrator otvara postavke za kreiranje jezika putem proširene administratorske navigacijske trake
							\item Administrator pretražuje jezik koji želi urediti
							\item Pritisak na gumb za uređivanje
						\end{packed_enum}
					\end{packed_item}
