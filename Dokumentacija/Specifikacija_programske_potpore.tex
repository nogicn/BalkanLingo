				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\begin{packed_item}
							...
							\\1. Korisnik dobije obavijest da je taj rječnik već dodao
						\end{packed_item}
					\end{packed_item}
					...
					\begin{packed_item}
						...
						\begin{packed_enum}
							...
							\item Na dnu stranice pritisne gumb za iduću riječ ili izlaz iz rječnika
						\end{packed_enum}
					\end{packed_item}
					...
					\begin{packed_item}
						...
						\begin{packed_enum}
							...
							\item Korisnik odabire neku hrvatsku riječ
							\item Ovisno o točnosti odabira, dobiva povratnu informaciju
							\item Na dnu stranice pritisne gumb za iduću riječ ili izlaz
						\end{packed_enum}
					\end{packed_item}
